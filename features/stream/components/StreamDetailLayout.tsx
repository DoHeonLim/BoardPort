...
export default function StreamDetailLayout({
  ...
  return (
    ...
    >
      <div className={cn("min-w-0 shrink-0 pt-2.5", isChatOpen && "lg:w-full")}>
        {detail}
      </div>

      {isChatOpen && (
        <aside className="mt-1.5 min-h-0 min-w-0 flex-1 lg:sticky lg:top-3 lg:mt-2 lg:h-[90dvh] lg:max-h-[90dvh] lg:w-[320px] lg:flex-none xl:w-[360px]">
          {chat}
        </aside>
      )}
    </div>
