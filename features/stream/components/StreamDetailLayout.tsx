 ...
 * 2026.05.28  임도헌   Modified  모바일 채팅 입력 집중 모드에서 상세 영역을 접고 채팅 레일을 확장
 */
...
export default function StreamDetailLayout({
  ...
  return (
    <div
      className={cn(
        "mx-auto flex min-h-0 w-full flex-1 flex-col overflow-hidden px-3 sm:px-4 lg:overflow-visible",
        isChatOpen
    ...
    >
      <div
        className={cn(
          "min-w-0 shrink-0 pt-2.5 transition-[height,opacity,padding] duration-200",
      ...
      {isChatOpen && (
        <aside
          className={cn(
            "mt-1.5 min-h-0 min-w-0 flex-1 transition-[margin] duration-200 lg:sticky lg:top-3 lg:mt-2 lg:h-[90dvh] lg:max-h-[90dvh] lg:w-[320px] lg:flex-none xl:w-[360px]",
