/**
 * File Name : features/stream/utils/clientToken.ts
 ...
 * 2026.01.23  임도헌   Moved     lib/stream/getRealtimeClientToken -> utils/clientToken
 * 사용 목적
...
export function getRealtimeClientToken(): string {
  ...
  try {
    ...
    // 3. Storage 사용 불가(Private Mode 등) 시 메모리 변수 사용
