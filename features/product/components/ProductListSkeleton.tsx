 ...
 * 제품 목록 본문 스켈레톤
 *
 * - 실제 `ProductList`와 같은 list/grid 밀도로 카드 뼈대를 맞춘다
 * - 라우트 전용 loading UI가 이미 헤더/툴바 스켈레톤을 그릴 때는 `showToolbar={false}`로 중복을 회피
 * - 헤더 내부 Suspense fallback처럼 본문만 교체되는 경우에는 툴바까지 함께 렌더링할 수 있다
 */
