 ...
 * Description : 제품 목록 문맥 복원 후 모달 상세 재오픈을 담당하는 릴레이
 * Author : 임도헌
 *
 * History
 ...
 * 2026.08.24  임도헌   Modified  Next.js 16 모달 편집 복귀의 기본 재오픈 경로로 역할 확대
 */
 ...
 * - Next.js 16에서 canonical 상세로 잘못 복귀하지 않도록 인터셉트 상세를 결정적으로 다시 연다
 */
