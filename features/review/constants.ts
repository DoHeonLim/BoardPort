 ...
 * 2026.09.13  임도헌   Modified  사용자 오류 문구를 거래 후기로 통일
 */
...
export const REVIEW_ERRORS = {
  ...
  INVALID_STATUS: "판매 완료 상태에서만 거래 후기를 작성할 수 있습니다.",
  ALREADY_EXISTS: "이미 이 상품에 거래 후기를 작성하셨습니다.",
  SERVER_ERROR: "거래 후기 처리 중 오류가 발생했습니다.",
} as const;
