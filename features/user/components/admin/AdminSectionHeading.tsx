 ...
 * 2026.04.28  임도헌   Modified  보드게임 관리 섹션명을 관리자 헤더 매핑에 추가
 * 2026.05.05  임도헌   Modified  관리자 섹션 heading 컴포넌트 JSDoc 보강
 */
...
const SECTION_TITLES = [
  ...
  { prefix: "/admin/boardgames", label: "도감 관리" },
  { prefix: "/admin/logs", label: "감사 로그" },
  { prefix: "/admin", label: "대시보드" },
];

/**
 * 현재 관리자 route prefix에 맞는 섹션명의 sticky admin header 표시
 *
 * @returns 관리자 콘솔 섹션 heading
 */
