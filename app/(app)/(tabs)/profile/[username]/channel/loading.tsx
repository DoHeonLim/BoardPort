/**
 * File Name : app/(app)/(tabs)/profile/[username]/channel/loading.tsx
 ...
 * 2026.04.12  임도헌   Moved     파일 경로를 app/(tabs)/profile/[username]/channel/loading.tsx 에서 app/(app)/(tabs)/profile/[username]/channel/loading.tsx 로 변경 (라우트 그룹 개편)
*/
