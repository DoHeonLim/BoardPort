/**
 * File Name : app/(public)/offline/page.tsx
 ...
 * 2026.01.14  임도헌   Modified  시멘틱 토큰 적용
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen px-6 bg-background transition-colors text-center">
      ...
      <div className="mb-8 flex flex-col items-center gap-4">
        ...
        <Logo variant="full" size={160} unoptimized className="opacity-80" />
      </div>
      ...
      <Link
        href="/"
        className={cn(
          "btn-primary h-12 px-10 text-base font-medium shadow-lg",
