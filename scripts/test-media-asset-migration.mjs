...
if (!databaseUrl)
  throw new Error("MEDIA_MIGRATION_TEST_DATABASE_URL is required.");
...
if (
  ...
  throw new Error(
    "Media migration test must use the local boardport_migration_test database."
  );
}

const prismaCli = resolve("node_modules/prisma/build/index.js");
const prismaConfig = resolve("prisma/config/media-migration-test.config.ts");
